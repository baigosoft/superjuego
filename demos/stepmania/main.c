...
typedef struct
{
	...
	int numnotedata;/*numero de elementos del array de las notas*/

	char **notedata;/*array de las notas*/

	int numres;/*numero de elementos del array de resolucion de las notas*/

	int *resolution;/*array de resolucion de las notas*/	
