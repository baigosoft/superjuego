...
SE_movie *SE_movie_load(const char *path)
{
	...
	av_strlcpy(is->filename,path, 1024);
...
#ifndef __DARWIN__
  videoscreen = SDL_SetVideoMode(640, 480, 0, 0);
#else
  videoscreen = SDL_SetVideoMode(640, 480, 24, 0);
#endif
  if(!videoscreen) {
