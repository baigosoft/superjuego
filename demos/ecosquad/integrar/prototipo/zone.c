...
void load_images_zone()
{
	...
	/*cargamos imagenes*/
	mapzone = SE_image_load("mapzone.png");
	tilebgzone = SE_image_load("tilebgzone.png");
	fzoneimg = SE_image_load("font256.png");
	...
	SE_tilemap_loadmapimage(bgzone,"mapimagezone.txt");
